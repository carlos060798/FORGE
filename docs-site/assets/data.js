/* ============================================================
   FORGE v4.0.0 — datos documentación completa (bilingüe ES/EN)
   10 secciones + 40+ subsecciones
   ============================================================ */
...
/* ────────────────────────────────────────────────────────────
   SECCIÓN 1: AGENTES (14 perfiles detallados)
──────────────────────────────────────────────────────────── */
...
"agentes-arquitecto": {
  ...
  es: {
    ...
    html: `
      ...
      <h2>Perfil</h2>
      <table>
        <tr><td><strong>Modelo</strong></td><td>Claude Opus 3.5</td></tr>
...
Decisiones registradas en memoria/ bajo "jwt-postgres-api"</code></pre>
  ...
  en: {
    ...
    html: `
      ...
      <h2>Profile</h2>
      <table>
        <tr><td><strong>Model</strong></td><td>Claude Opus 3.5</td></tr>
        <tr><td><strong>Token budget</strong></td><td>200,000 tokens</td></tr>
...
"agentes-critico": {
  ...
  es: {
    ...
    html: `
      ...
      <h2>Perfil</h2>
      <table>
        <tr><td><strong>Modelo</strong></td><td>Claude Sonnet 3.5</td></tr>
...
Salida: critica.md con 8 puntos sin resolver</code></pre>
  ...
  en: {
    ...
    html: `
      ...
      <h2>Profile</h2>
      <table>
        <tr><td><strong>Model</strong></td><td>Claude Sonnet 3.5</td></tr>
        <tr><td><strong>Token budget</strong></td><td>80,000 tokens</td></tr>
...
agentes:
  ...
  asesor:                { modelo: "claude-haiku-4-5" }
